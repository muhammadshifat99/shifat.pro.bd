...
My personal portfolio — designed and built as one continuous experience.
...
- **Wordmark handoff** — the name mark animates out of the loader and lands in the hero
...
All personal content lives in `lib/content.ts` — nothing personal is hardcoded in the components.

---

© 2026 Muhammad Shifat
